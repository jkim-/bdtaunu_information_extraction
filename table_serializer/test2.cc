...
int main() {
  ...
  for (size_t cidx = 0; cidx < ny; ++cidx) {
    ...
    csv.set("tag_costhetadl", 
        pu::type2string(ytagbcosthetadlcm[cidx]));
    csv.set("tag_isbdstar", 
    ...
    csv.set("sig_costhetadsoft", 
        pu::type2string(ysigbcosthetadsoftcm[cidx]));
    csv.set("sig_softp3magcm", 
