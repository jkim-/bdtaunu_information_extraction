...
executable_path = '../serialize_features'
executable_cfg_template = 'serialize_features_{0}.cfg'

prepare_sql_script_template = 'prepare_serialization_inputs_{0}.sql'
populate_sql_script_template = 'populate_serialized_tables_{0}.sql'
